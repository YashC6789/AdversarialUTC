...
LLM_MODEL = AutoModelForCausalLM.from_pretrained("Qwen/Qwen3-0.6B", device_map={'': 'cpu'}, torch_dtype='auto')
LLM_TOKENIZER = AutoTokenizer.from_pretrained("Qwen/Qwen3-0.6B")
...
def eval(
    ...
    attacked_results = pd.DataFrame(rows, columns=["text"])
